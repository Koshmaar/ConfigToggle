...
namespace ConfigToggle
{
	...
	{
        private String pluginName = "ConfigToggle";
        private String pluginGuid = "64B999EB-EC9C-4263-AF25-E2E6DF733107";
        private String pluginHelp = "www.flashdevelop.org/community/";
        private String pluginDesc = "Allows toggling compiler constants";
        private String pluginAuth = "Hubert Rutkowski";
        ...
        public void InitBasics()
        {
            ...
            this.pluginImage = PluginBase.MainForm.FindImage("105");
        }
        ...
        public void CreateMenuItem()
        {
            ...
            viewMenu.DropDownItems.Add(new ToolStripMenuItem("CONFIG::toggle plugin", this.pluginImage, new EventHandler(this.OpenPanel), this.settingObject.SampleShortcut));
